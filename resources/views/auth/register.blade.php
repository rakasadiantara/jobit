    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card-register">
                <div class="card-header-login text-login">{{ __('Job Seeker Registrations') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        <input type="hidden" value="seeker" name="user_type" id=""> {{--dibuat hidden agar tak terlihat di tampilan form--}}
