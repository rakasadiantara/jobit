            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            {{-- <a class="nav-link font-weight-bold text-light" href="{{ route('employer.registration') }}">{{ __('Blog') }}</a> --}}
                            <a class="nav-link font-weight-bold text-light" href="#">Blog</a>
                        </li>
                        @guest
                            <li class="nav-item">
                            ...
                            @if (Route::has('employer.registration'))
                                <li class="nav-item">
                                    <a class="nav-link font-weight-bold text-light" href="{{ route('employer.registration') }}">{{ __('Employer Registration') }}</a>
                                </li>
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link font-weight-bold text-light dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    @if (Auth::user()->user_type == 'employer')
            ...
            <footer class="text-center text-lg-start" style="background-color: #1E385A; color : #FFFFFF">
                ...
                <div class="container p-4">
                    ...
                    <div class="mr-auto col-lg-3 col-md-4 mb-2 mb-md-0">
                        <h6 class="text-left">About</h6>
                        <h6 class="text-left">Career</h6>
                        <h6 class="text-left">Internships</h6>
                        <h6 class="text-left">Blog</h5>
                            ...
                            <div class="col">
                                <div class="input-group mb-3">
                                    ...
                                    <div class="input-group-append">
                                      <a class="btn btn-outline-success text-light" type="button" id="subscribe">Subsribe</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        {{-- <div class="mb-3">
                            <input for="email" class="col-form-label" placeholder="example@mail.com" aria-label="Newsletter">
