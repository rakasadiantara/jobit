            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{route('viewuser')}}">Daftar User</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{route('viewjob')}}">Daftar Pekerjaan</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{route('viewadmin')}}">Daftar Admin</a>
                  </li>
                </ul>
              </div>
            </li>
